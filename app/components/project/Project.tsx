...
const Project = (projectProps : ProjectProps) => {
  return (
    <>
            <ShineBorder
              className="relative flex flex-col w-[300px] md:w-[400px] items-center justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl space-y-2 bg-black text-white md:h-[180px]"
